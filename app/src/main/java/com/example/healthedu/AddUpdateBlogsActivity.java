...
public class AddUpdateBlogsActivity extends AppCompatActivity {
    ...
    private static final int IMAGE_PICKER_CAMERA_CODE = 102;
    private static final int IMAGE_PICKER_GALLERY_CODE = 103;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_update_blogs);
    ...
    private void inputData() {
        ...
        long id = db.insertRecord(""+title, ""+description, ""+imageUri);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (resultCode == RESULT_OK){
            if (requestCode == IMAGE_PICKER_GALLERY_CODE){
                CropImage.activity(data.getData()).setGuidelines(CropImageView.Guidelines.ON).setAspectRatio(1,1).
                        start(this);
            }
